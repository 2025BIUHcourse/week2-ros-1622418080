...
![文件管理操作示例](screenshots/screenshot_07.png)
...
![安装 tree 工具示例](screenshots/screenshot_148.png)
...
![进程管理示例（ps / kill）](screenshots/screenshot_149.png)
...
- ![VSCode 调试示例](screenshots/screenshot_18.png)
...
![ROS 安装示例 1](screenshots/screenshot_10.png)
...
![roscore 输出示例](screenshots/screenshot_05.png)
...
操作效果截图：
![运行示例](screenshots/screenshot_08.png)
...
![截图 09：Turtlesim 键盘控制示例](screenshots/screenshot_12.png)
...
```
![运行示例](screenshots/screenshot_16.png)
...
angular:\
    ...
    z: 0.8"
```
![运行示例](screenshots/screenshot_02.png)
可视化：
...
```
![运行示例](screenshots/screenshot_03.png)
![运行示例](screenshots/screenshot_01.png)
